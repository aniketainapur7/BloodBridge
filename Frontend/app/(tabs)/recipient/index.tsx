    ...
    <View style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        <TouchableOpacity
          ...
          onPress={() => router.push('/(tabs)/recipient/request')}
        >
        ...
        <TouchableOpacity
          style={styles.mainButton}
          onPress={() => router.push('/(tabs)/recipient/history')}
        >
        ...
        <TouchableOpacity
          ...
          onPress={() => router.push('/(tabs)/recipient/sos')}
        >
      ...
      <Modal visible={profileVisible} transparent animationType="slide">
        <View style={styles.rightSlideOverlay}>
          <View style={styles.rightSlidePopup}>
            ...
            <Text style={styles.popupTitle}>Your Profile</Text>
