...
export default function RegisterScreen() {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      Alert.alert('Registration Successful', `Welcome, ${response.data.fullName}!`);
  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput placeholder="Phone Number" style={styles.input} value={phone} keyboardType="phone-pad" onChangeText={setPhone} />
